...
DATA_FILE_PREFIX = "/home/hiraj/moby_simulator/data2/"
SEED_FILE_PREFIX = "/home/hiraj/moby_simulator/data2/seeds/"
...
def main():
	...
	messagegenerationtype = int(args.messagegenerationtype)
	...
	configuration = 0 if messagegenerationtype == 1 else 1
	...
	for hour in xrange(message_sending_hours):
		...
		with open(current_message_file, "a+") as out_file:
			...
			for i in xrange(message_number):
				...
				if messagegenerationtype == 1:
					src, dst = random.sample(userpool.keys(), 2)
				elif messagegenerationtype == 2:
